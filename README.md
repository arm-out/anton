...
| :-----------------------------------------------------------: | ---------------------------------------------------------- | :----------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------: | :-----------: |
| [0.4.0](https://github.com/arm-out/anton/releases/tag/v0.4.0) | quiescent search, transposition table and TT move ordering | [+562.6](https://github.com/arm-out/anton/pull/4#issue-4543080049) |                                                                                                                 |               |
